...
class TestCloudWrapper(TestCloudConnectorsBase):
    ...
    def setUp(self):
        ...
        self.configHolder = ConfigHolder({'username':base64.b64encode('user'), 
    ...
    def test_putImageId(self):
        ...
        cw.clientSlipStream.httpClient._call.\
                assert_called_with('%s/module/Name/Test' % self.serviceurl,
