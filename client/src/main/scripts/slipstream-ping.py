    ...
    def doWork(self):
        ...
        if status != oldStatus:
            ...
            if self.withSms:
                ...
                urllib2.urlopen('http://www.chrus.ch/mysms/http/send.php?user=41774468119&pwd=smSstatuS2009&from=41774468119&to=41774468119,33677907238&msg=%s' % msg.replace(' ', '+'))
        if error:
            sys.exit(-1)
        return
